...
Multiplatform Multi-integration Multipurpose Fast Compilation System built upon CToy for Fast Creative Audio-Visual Development is an interactive C(99) coding environment based on [TCC](http://bellard.org/tcc/). This project has been forked from [C-Toy](https://github.com/anael-seghezzi/CToy)
